...
let doGetBin = (() => {
    var _ref = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (name, dirName, url, sha2) {
        const cachePath = (_path || _load_path()).join((0, (_util || _load_util()).getCacheDirectory)(), name);
        const dirPath = (_path || _load_path()).join(cachePath, dirName);
        const dirStat = yield (0, (_util || _load_util()).statOrNull)(dirPath);
        ...
        const tempUnpackDir = (_path || _load_path()).join(cachePath, (0, (_util || _load_util()).getTempName)());
        ...
        yield (0, (_httpRequest || _load_httpRequest()).download)(url, archiveName, {
...
function _load_httpRequest() {
    return _httpRequest = require("./httpRequest");
}
