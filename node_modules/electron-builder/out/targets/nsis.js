...
class NsisTarget extends (_platformPackager || _load_platformPackager()).TargetEx {
    ...
    buildInstaller() {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            const installerPath = (_path || _load_path()).join(_this2.outDir, installerFilename);
            ...
            const publishConfigs = yield _this2.publishConfigs;
                ...
                for (let publishConfig of publishConfigs) {
                    if (publishConfig.provider === "generic" || publishConfig.provider === "github") {
                        ...
                        if (publishConfig.provider === "generic") {
                            yield (0, (_fsExtraP || _load_fsExtraP()).writeFile)((_path || _load_path()).join(_this2.outDir, `${ channel }.yml`), (0, (_jsYaml || _load_jsYaml()).safeDump)({
                                version: version,
